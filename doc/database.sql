...
CREATE TABLE IF NOT EXISTS `activity` (
  ...
  KEY `activity` (`timestamp`,`activity`,`object_type`,`object_id`,`affected_user_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `group` (
  ...
  KEY `top_groups` (`group_visibility_level`,`group_status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `group_user` (
  ...
  KEY `membership` (`user_id`,`group_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `language` (
  ...
  KEY `language_flag` (`language_flag`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `resource` (
  ...
  KEY `top_resources` (`resource_visibility_level`,`resource_status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `resource_user_group` (
  ...
  KEY `unread_messages` (`member_id`,`member_type`,`resource_id`,`resource_opened_by_user`),
  KEY `members` (`member_id`,`member_type`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `tag` (
  ...
  PRIMARY KEY (`tag_id`),
  KEY `tag_id` (`tag_id`,`tag_parent_id`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `user` (
  ...
  KEY `top_users` (`user_visibility_level`,`user_status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `user_friend` (
  ...
  KEY `user_id` (`user_id`,`friend_id`,`user_friend_status`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
...
CREATE TABLE IF NOT EXISTS `visits` (
  ...
  KEY `visit` (`type_id`,`object_id`,`ip_address`)
) ENGINE=InnoDB  DEFAULT CHARSET=utf8;
